package com.j797.movie_review.service;

import com.j797.movie_review.model.Movie;
import com.j797.movie_review.model.Review;
import com.j797.movie_review.repository.MovieRepository;
import com.j797.movie_review.repository.ReviewRepository;
...
public class ReviewService {
    ...
    public Review create(Long movieId, Review review) {
        Movie movie = movieRepository.findById(movieId)
                .orElseThrow(() -> new NoSuchElementException("리뷰가 없습니다: " + movieId));
